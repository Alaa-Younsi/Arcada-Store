...
const Section = ({ title, children }: { title: string; children: React.ReactNode }) => (
  <div className="mb-10">
    <h2 className="font-display font-bold text-white uppercase tracking-[0.15em] text-lg mb-4 border-l-2 border-accent pl-4">
      {title}
    </h2>
    <div className="font-sans text-sm text-muted leading-relaxed space-y-3 pl-4">{children}</div>
  </div>
);
...
export default function TermsOfService() {
  return (
    <>
      <SEOHead title="Terms of Service — ARCADA" />

      <div className="min-h-screen py-20 px-4">
        <div className="max-w-3xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <p className="font-sans text-accent text-xs uppercase tracking-[0.3em] mb-3">Legal</p>
            <h1 className="font-display font-light text-white uppercase tracking-[0.15em] text-4xl md:text-5xl mb-3">
              TERMS OF SERVICE
            </h1>
            <p className="font-sans text-[#555] text-xs mb-12">Last updated: April 2026</p>

            <div className="bg-white border border-border p-8 md:p-12 rounded-2xl">
              <Section title="1. Acceptance of Terms">
                <p>
                  By accessing and using ARCADA ("the Website"), you accept and agree to be bound by these Terms of
              ...
              <Section title="2. Products and Orders">
                <p>
                  All products listed on ARCADA are subject to availability. We reserve the right to discontinue
              ...
              <Section title="3. Shipping and Delivery">
                <p>
                  We ship to the address provided at checkout. ARCADA is not responsible for incorrect addresses
              ...
              <Section title="5. Intellectual Property">
                <p>
                  ...
                  of ARCADA and is protected by applicable intellectual property laws.
                </p>
                <p>
              ...
              <Section title="6. Limitation of Liability">
                <p>
                  To the maximum extent permitted by law, ARCADA shall not be liable for any indirect,
