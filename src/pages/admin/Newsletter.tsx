  ...
  return (
    <div className="p-6 lg:p-8">
        ...
        <div className="flex gap-2 flex-wrap">
          {selected.size > 0 && (
            <button
              ...
              className="flex items-center gap-2 font-sans text-xs text-[#8B7355] border border-[#8B7355]/30 px-3 py-2 hover:bg-[#1A1714]/10 transition-colors"
            >
              <Trash2 size={12} />
          ...
          <button
            ...
            className="flex items-center gap-2 font-sans text-xs text-[#6B6459] hover:text-[#1A1714] border border-[#E8E2D9] px-3 py-2 hover:border-[#333] transition-colors disabled:opacity-40"
          >
            <Download size={12} />
            Export CSV
          </button>
      ...
      {loading ? (
        ...
        <div className="bg-white border border-[#E8E2D9] p-16 text-center">
          <Mail size={40} className="text-[#333] mx-auto mb-4" />
          <p className="font-sans text-[#6B6459] text-sm">No subscribers yet.</p>
          <p className="font-sans text-[#555] text-xs mt-1">
        ...
        <div className="bg-white border border-[#E8E2D9] overflow-hidden">
          {/* Table header */}
          <div className="flex items-center gap-4 px-4 py-3 border-b border-[#E8E2D9] bg-[#F2EDE6]">
            <input
              type="checkbox"
            ...
            />
            <span className="font-sans text-xs text-[#555] uppercase tracking-[0.15em] flex-1">Email</span>
            <span className="font-sans text-xs text-[#555] uppercase tracking-[0.15em] hidden sm:block">Subscribed</span>
            <span className="w-6" />
          </div>
          ...
          {subscribers.map((sub, i) => (
            <motion.div
              ...
              className={`flex items-center gap-4 px-4 py-3 border-b border-[#111] transition-colors ${
                selected.has(sub.id) ? 'bg-[#1A1714]/5' : 'hover:bg-[#F2EDE6]'
              }`}
            >
              <input
                type="checkbox"
              ...
              <div className="flex items-center gap-2 flex-1 min-w-0">
                <Mail size={12} className="text-[#8B7355] flex-shrink-0" />
                <span className="font-sans text-sm text-[#1A1714] truncate">{sub.email}</span>
              </div>
              <span className="font-sans text-xs text-[#555] hidden sm:block whitespace-nowrap">
