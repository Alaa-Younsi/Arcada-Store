...
-- Only users with is_admin = true in their JWT app_metadata can write
...
DROP POLICY IF EXISTS "products_admin_full"    ON products;

-- Public storefront: only show active products
